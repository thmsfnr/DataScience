...
# import afficheGraphePrediction
...
plt.savefig('prevision-production/nucleaire/production-nucleaire.png')
...
#sauvegarde du graphique
plt.savefig('prevision-production/nucleaire/prevision-nucleaire.png')
...
plt.savefig('prevision-production/nucleaire/analyse-prevision-nucleaire.png')
...
print(df_cv)
afficheGraphePrediction(df_cv,forecast,"Analyse de la cross validation de la production d'électricité en MWh pour le nucléaire en fonction des années")
plt.savefig('prevision-production/nucleaire/analyse-cross-validation-nucleaire.png')
...
#y valeurs réelles , yhat valeurs prédites
...
forecast.to_csv('prevision-production/nucleaire/prevision-nucleaire.csv', index=False)